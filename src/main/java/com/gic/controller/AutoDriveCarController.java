...
public class AutoDriveCarController {
    ...
    public ResponseEntity<Object> getCarEndingPositionAndDirection(@Valid final @RequestBody CarInputRequest carInputRequest) throws Exception{

        final CarEndingPosition carEndingPos = autoDriveCarService.getCarEndingPositionAndDirection(carInputRequest);
